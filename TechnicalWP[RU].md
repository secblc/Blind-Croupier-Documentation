...
8. Для игры используется примитивный генератор псевдослучайных чисел (PRNG) на основе заданного случайного сида:
...
16. Банк в фоне воспроизводит партию на основе полученных данных и выплачивает Игроку его выигрыш (если таковой имеется).
