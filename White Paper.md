...
>Однако стоит заметить, что если все токены в периоде выкуплены то начинается новый без замедлений, что теоретически может привести к быстрому завершению продажи токенов в случае возникновения черезвычайно высокого интереса среди инвесторов. Но при только условии 100% продажи токенов в периоде,  цена в новом периоде тоже становится выше и в определенный момент покупка станет не выгодной, до тех пор пока часть токенов не будет выведена из оборота или мы не продвинимся вперед по дорожной карте. 

2. Минимальная оценка доли - инвестор заранее знает общее колличество токенов и как они будут распределены, единственное что не известно ни кому, это сколько токенов будет изъято из оборота [ведь все не проданные токены уничтожаются после каждого периода]. Но если мы уничтожим больше токенов значит и доля инвестора станет только выше и благоприятно повлияет на сделанную инвестицию в целом.

3. Ограниченная эмиссия - максимальная эмиссия ограничена умным контрактом.

4. Отсутствие центрального механизма -  в руках команды Blind Croupier не должно остаться достаточного колличества токенов для манипулирования ценой. Даже если будет уничтоженно 50% от выставленных на продажу токенов в руках Blind Croupier окажется 28% от общего колличества токенов. Часть из которых обязательно дополнительно будет отправлена на счет маркет мейкера, который будет обеспечивать стабильную цену токена на рынке.

5. Рыночная эффективность - гибкость предложенной модели основана на росте цены токена в новых периодах, до тех пор пока она устраивает инвесторов. Если спрос уменьшается то предложение тоже уменьшается (путем сжигания не проданных токенов после каждого периода), все это происходит до тех пор не достигнется баланса между спросом и предложением.
