 ...
 **420,000,000BCT:**  Выставлено на продажу, Pheriod 1=10,000,000BCT, для каждого последующего периода 1,000,000BCT. Во время Pheriod 1-25 проводится аукцион привилегий.
...
>Однако стоит заметить, в случае возникновения черезвычайно высокого интереса среди инвесторов, и выкупе всех токенов из периода то новый период начинется без замедлений, что теоретически может привести к быстрому завершению Pheriod 411. Но цена в каждом новом периоде становится выше и в определенный момент покупка станет не выгодной, до тех пор пока она не будет обоснована. Обоснование цены будет осуществляться путем вывода из оборота не проданных токенов*[меньше спрос/меньше и предложения]* и продвижением вперед по дорожной карте.
