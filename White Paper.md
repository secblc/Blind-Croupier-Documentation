...
WIN это главный токен Blind Croupier стандартна ERC20. Всего будет выпущено 500,000,000WIN из них 420,000,000WIN, выставлено на продажу, которая пройдет на протяжении 411 раздельных периодов.  Для Pheriod 1 доступно 10,000,000WIN распределение которых будет проходить в течении 161 часа, для каждого нового периода доступно 1,000,000WIN период длится 23 часа. Если все доступные для периода токены выкупаются, то новый период начинается без замедлений.  Все не проданые в периоде токены сжигаются сразу же после окончания периода. Продажа токенов начнется **с 13 августа 2017 года НАПИСАТЬ И ВРЕМЯ** и закончится по окончанию 411 периода. Пожалуйста, внимательно ознакомьтесь настоящим документом, прежде чем принять свое участие в распределение токенов.
 ...
 **420,000,000WIN:**  Выставлено на продажу, Pheriod 1=10,000,000WIN, для каждого последующего периода 1,000,000WIN. Во время Pheriod 1-25 проводится аукцион привилегий.
...
**10,000,000WIN:** Эти токены будут направлены на баланс маркет мейкера. Маркет мейкер это дилер/робот/брокер который будет хранить на своем счете токены WIN, и организовывать их продажу, поддерживая высокую ликвидность токенов на рынке, путем обеспечения быстрой покупки и продажи токенов на бирже.
