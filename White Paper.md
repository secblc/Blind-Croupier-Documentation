...
Выше описаннная модель продажи токенов была разработана нами, исходя из потребностей инвесторов, которые по нашему мнению и [членов блокчейн сообщества](http://vitalik.ca/general/2017/06/09/sales.html), считаются наиболее акктуальными, ниже мы опишем наиболее важные на наш взгляд проблемы которые решает данная модель:
