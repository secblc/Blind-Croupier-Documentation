...
Выше описаннная модель продажи токенов была разработана нами, исходя из потребностей инвесторов и для закрытия тех пробелов в механизме продаже токенов, которые по нашему и мнению членов блокчейн сообщества считаются наиболее акктуальными, ниже мы опишем наиболее важные на наш взгляд моменты которые предоставляет данная модель, на **реальном** примере проекта Blind Croupier: 

1. Постепенное финансирование - Мы видем в этом отличную возможность для инвестора приглядеться к проекту, посмотреть как исполняются данные командой обещания, и разделить свои капиталовложения в Blind Croupier на несколько этапов. Для себя мы видим отличную возможность абсолютно доказать свои благие намериния и дать рынку проголосовать монетой за наш проект и дальнейшую цену токена.
...
3. Гибкая эмиссия и возможность роста - предположим, что в периоде 120 цена достигла 0.3$ и было продано 300,000BCT(30%). Интерес инвесторов времено затих им кажется цена в окне выше чем может стоить токен. Для этого все не проданные токены сжигаются после каждого периода, уменьшая общее их колличество, тем самым ограничивая предложение и стимулируя спрос, увеличивая долю владельцев токенов. Цена не повысится до тех пор пока не будет выкуплено 80% или более токенов.
