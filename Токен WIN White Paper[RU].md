...
### Цена Period 2-367: 
+0.5% от цены предыдущего периода.
**Если** предыдущий период закончился досрочно, в новом периоде цена увеличивается на 1%.
 ...
 **366,000,000WIN:**  Предложено для периодов 2-367.  Для каждого из них выделено 1,000,000WIN, распределение которых пройдет в течении 23 часов(или пока все токены не будут распределены). В случае досрочной продажи, периоды идут один за другим без замедлений.
