...
+ Поддержка участников распределения токенов WIN на родном языке. В местных группах (Slack, Telegram\Wechat, QQ в зависимости от языка).
...
Для предложенной, постепенной модели распределения токенов WIN, необходима гибкая система для рационального распределения баунти. Так как распределение токенов разбито на множество раундов, нам достаточно тяжело предсказать, какая вакансия может оказаться наиболее подходящей спустя некоторое время, что еще более важно наиболее востребованной (однако мы твердо уверены в необходимости проведения кампании для комьюнити менеджеров и твитер кампании).
